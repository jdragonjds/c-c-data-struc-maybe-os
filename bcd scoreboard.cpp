...
void yn(int x) { if(!x)cout << "NO\n";  else if(x)cout << "YES\n";return; }

const ll N=2e5+5,M=1e9+7,mod=1e9+7;
  

const int DIV = 1e5;

inline int bcdtod(string s,int d) {
     string bcd[10] ={"1110111", "0010010", "1011101", "1011011", "0111010", "1101011", "1101111", "1010010", "1111111", "1111011"};
 int c=0;
 rep(i,0,7){
if(s[i]=='1'&& bcd[d][i]=='0')return -1;
else if(s[i]=='0' && bcd[d][i]=='1')c++;
 }
